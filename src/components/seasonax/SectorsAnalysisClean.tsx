...
const SectorsAnalysis: React.FC = () => {
    ...
    if (loading) {
        return (
            <div className="sectors-analysis-container" style={{ position: 'relative', minHeight: '100vh' }}>
                <OptionsFlowScene visible={true} selectedTicker="SECTORS" streamingStatus="Analyzing Market Sectors & Industries..." fill />
            </div>
        );
    }
            ...
            <div className="analysis-controls">
                ...
                <div className="filter-controls">
                    ...
                    >
                        ...
                        <option value="industries"> Industries Only</option>
                    </select>
                ...
                <div className="summary-card">
                    ...
                    <div className="summary-stats">
                        ...
                        <div className="summary-stat">
                            ...
                            <span className={`stat-value ${analysis.reduce((sum, item) => sum + item.sector.changePercent, 0) / analysis.length >= 0
                                    ? 'positive' : 'negative'
                                }`}>
