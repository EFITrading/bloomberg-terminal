        ...
        try {
            ...
            for (const symbolInfo of symbols) {
                try {
                    ...
                    if (!data.success) {
                        console.warn(` Failed to get data for ${symbolInfo.symbol}: ${data.error}`);
                        continue;
                    }
    ...
    if (loading) {
        return (
            <div className="sectors-analysis-container" style={{ position: 'relative', minHeight: '100vh' }}>
                <OptionsFlowScene visible={true} selectedTicker="SEASONAL" streamingStatus="Loading Weekly Seasonal Patterns..." fill />
            </div>
        );
    }
