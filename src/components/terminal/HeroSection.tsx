...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    // LED text cycling - changes once per day based on day of year
    const ledWords = ['HELL', 'NICE', 'SICK', 'FIRE', 'DOPE', 'EPIC']
    const dayOfYear = Math.floor(
      (Date.now() - new Date(new Date().getFullYear(), 0, 0).getTime()) / 86400000
    )
    setLedText(ledWords[dayOfYear % ledWords.length])

    // Schedule update at next midnight
    const now = new Date()
    const msUntilMidnight =
      new Date(now.getFullYear(), now.getMonth(), now.getDate() + 1).getTime() - now.getTime()
    const ledInterval = setTimeout(() => {
      const nextDay = Math.floor(
        (Date.now() - new Date(new Date().getFullYear(), 0, 0).getTime()) / 86400000
      )
      setLedText(ledWords[nextDay % ledWords.length])
    }, msUntilMidnight)
    ...
    },
    {
      icon: (
        <svg viewBox="0 0 24 24" className="feature-svg">
          ...
          <path
            d="M3 17l6-6 4 4 8-8V9h-2V7l-6 6-4-4-8 8v1h2v2z"
            fill="url(#derivGrad)"
            className="wave-motion"
          />
          <path
            d="M21 7h-4v2h2v2l-6 6-4-4-6 6v2l8-8 4 4 6-6V7z"
            fill="none"
            stroke="#60a5fa"
            strokeWidth="0.8"
            className="delta-trail"
          />
      ...
      <div className="hero-grid">
        <div className="hero-content">
          ...
          <p className="hero-description">
            Institutional-grade trading platform combining advanced seasonality analysis, real-time
            derivative flow monitoring, and AI-powered market regime detection. Built for
            quantitative researchers, portfolio managers, and systematic traders.
          </p>
            ...
            <div className="bunit-card">
              ...
              <div className={`fingerprint-sensor ${fingerActive ? 'scanning' : ''}`}>
                <svg className="fingerprint-svg" viewBox="0 0 80 80" fill="none">
                  ...
                  <path
                    d="M40 10 Q20 20 20 40 Q20 60 40 70"
                    stroke="#D4AF37"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M40 10 Q60 20 60 40 Q60 60 40 70"
                    stroke="#D4AF37"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M40 15 Q25 23 25 40 Q25 57 40 65"
                    stroke="#D4AF37"
                    strokeWidth="1.2"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M40 15 Q55 23 55 40 Q55 57 40 65"
                    stroke="#D4AF37"
                    strokeWidth="1.2"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M40 20 Q30 27 30 40 Q30 53 40 60"
                    stroke="#D4AF37"
                    strokeWidth="1"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M40 20 Q50 27 50 40 Q50 53 40 60"
                    stroke="#D4AF37"
                    strokeWidth="1"
                    strokeLinecap="round"
