                                    ...
                                    <div className="hidden lg:block relative p-6">
                                        <div className="flex items-center gap-8">
                                            ...
                                            <div className="flex-1 grid grid-cols-5 gap-8">
                                                ...
                                                <div>
                                                    <div className={`text-xl font-black ${item.strength > 75 ? 'text-purple-400' :
                                                ...
                                                <div>
                                                    {item.largestWall ? (
                                                        <div className={`text-xl font-black ${item.largestWall.type === 'call' ? 'text-red-500' : 'text-green-500'
                                                            }`}>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                <div className="bg-gray-900/50 rounded-lg p-2">
                                                    ...
                                                    <div className={`text-base font-black ${item.strength > 75 ? 'text-purple-400' :
                                                            item.strength >= 63 ? 'text-blue-400' :
                                                                item.strength >= 40 ? 'text-yellow-400' :
                                                                    'text-white'
                                                        }`}>
                                                ...
                                                <div className="bg-gray-900/50 rounded-lg p-2">
                                                    ...
                                                    {item.largestWall ? (
                                                        <div className={`text-base font-black ${item.largestWall.type === 'call' ? 'text-red-500' : 'text-green-500'
                                                            }`}>
                                                            ${item.largestWall.strike.toFixed(2)}
                                                        </div>
                                                    ) : (
                ...
                {activeTab === 'otm-premiums' && (
                    <div>
                        ...
                        <div className="space-y-3 px-3 md:px-6">
                            ...
                            {otmResults.length === 0 && !otmLoading && otmLastUpdate && (
                                <div className="text-center py-8 md:py-16">
                                    <div className="text-lg md:text-xl font-bold text-gray-500 mb-2 md:mb-3">No Results Found</div>
                                </div>
                            )}
                                ...
                                >
                                    ...
                                    <div className="hidden lg:grid grid-cols-12 gap-4 p-4 items-center">
                                        ...
                                        <div className="col-span-2 text-center">
                                            ...
                                            <div className={`text-3xl font-black ${result.imbalanceSeverity === 'EXTREME' ? 'text-red-500' :
                                        ...
                                        <div className="col-span-1 flex justify-end">
                                            <div className={`px-4 py-2 text-xs font-black ${result.imbalanceSeverity === 'EXTREME'
