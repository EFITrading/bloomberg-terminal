...
import { useGEXChartMobile } from './useGEXChartMobile';
...
export default function GEXChart({
  ...
  const { isMobile, margin: mobileMarginsConfig, svgWidth, svgHeight, marginTop: mobileMarginTop, svgStyle: mobileSvgStyle } = useGEXChartMobile(compactMode);
  ...
  */
  ...
  useEffect(() => {
    ...
    const margin = mobileMarginsConfig;
 ...
 `);
  ...
  return (
    <div style={{ marginTop: mobileMarginTop }}>
