...
const GEXTimelineScrubber: React.FC<GEXTimelineScrubberProps> = ({
      ...
      <div className="bg-gray-900/50 border border-yellow-600/50 rounded-lg p-4">
        <div className="flex items-center justify-center gap-2 text-yellow-400">
          <span className="text-sm">
            ⚠ No historical data available for {ticker} on {date}
          </span>
        </div>
      </div>
    )
  ...
  return (
    <div
      className="relative gex-timeline-container"
      style={{
        ...
        padding: '8px 16px',
        boxShadow:
          'inset 0 1px 0 rgba(255,255,255,0.1), 0 2px 8px rgba(0,0,0,0.6), 0 0 0 1px rgba(26,77,143,0.3)',
      }}
    >
      <style>{`
      ...
      <div className="flex items-center justify-between mb-2 gex-timeline-header">
          ...
          {selectedPoint && (
            ...
            >
              <div
                ...
                style={{ color: '#ff9000', fontFamily: 'monospace' }}
              >
                {selectedPoint.label}
              </div>
            </div>
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2">
          <h4
            className="text-sm font-bold uppercase tracking-widest gex-timeline-title"
            style={{
              color: '#4d9eff',
        ...
        {selectedPoint && (
          ...
          >
            <div
              className="text-xs font-bold"
              style={{ color: '#4d9eff', fontFamily: 'monospace' }}
            >
        ...
        >
          ...
          <div
            style={{
              ...
              width:
                selectedIndex !== null
                  ? `${(selectedIndex / (timelineData.length - 1)) * 100}%`
                  : '0%',
