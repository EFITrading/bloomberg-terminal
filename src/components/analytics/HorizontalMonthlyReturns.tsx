  ...
  return (
    <div className="horizontal-monthly-returns" style={{
      ...
      <div className="monthly-returns-main-container" style={{
        ...
        {/* Center - Monthly data: 1 row of 12 in fullscreen, 2 rows of 6 otherwise */}
        <div className="monthly-returns-container" style={{
          ...
          <div className="monthly-returns-row" style={{
            ...
            {monthlyData.slice(0, isFullscreen ? 12 : 6).map((month, index) => (
              <div
                key={index}
          ...
          {/* Second row - 6 months (Jul-Dec), hidden in fullscreen */}
          {!isFullscreen && (
            <div className="monthly-returns-row" style={{
              display: 'flex',
              flexDirection: 'row',
