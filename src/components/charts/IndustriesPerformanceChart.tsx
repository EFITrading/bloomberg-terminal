...
const IndustriesPerformanceChart: React.FC = () => {
  ...
  const [timeframe, setTimeframe] = useState<Timeframe>(() => {
    if (typeof window !== 'undefined') {
      const saved = localStorage.getItem('industriesPerformanceTimeframe')
      ...
      if (performanceData[0]?.data) {
        ...
        performanceData[0].data.forEach((point, index) => {
          ...
          if (!isMarket && shadingStart === null) {
            ...
            const x1 = xScale(shadingStart, performanceData[0].data.length)
            const x2 = xScale(index, performanceData[0].data.length)
  ...
  return (
    <div
      ...
      style={{
        width: '1000px',
        height: isFullscreen ? '840px' : '840px',
    ...
    >
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              if (typeof window !== 'undefined') {
                localStorage.setItem('industriesPerformanceTimeframe', newTimeframe)
              }
            }}
            style={{
              padding: '6px 12px',
      ...
      <div
        ...
        style={{
          width: '100%',
          height: isFullscreen ? '770px' : '770px',
          position: 'relative',
          backgroundColor: '#000000',
          transition: 'height 0.3s ease',
        }}
