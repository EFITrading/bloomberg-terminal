...
export default function AccountPage() {
  ...
  const handleLogout = async () => {
    ...
    // Sign out from Discord if logged in via Discord
    if (session) {
    ...
    <div className="min-h-screen bg-black text-white p-8 pt-24 flex flex-col items-center">
      <div className="max-w-4xl w-full mx-auto">
        ...
        <div className="relative overflow-hidden rounded-xl mb-6 shadow-2xl">
          ...
          <div className="relative border border-gray-700/50 rounded-xl p-8 backdrop-blur-xl" style={{
            background: 'linear-gradient(135deg, rgba(0,0,0,0.95) 0%, rgba(20,20,20,0.95) 50%, rgba(0,0,0,0.95) 100%)',
            boxShadow: '0 8px 32px rgba(0,0,0,0.8), inset 0 1px 0 rgba(255,255,255,0.1), inset 0 -1px 0 rgba(0,0,0,0.5)'
          }}>
              ...
              <div className="relative overflow-hidden rounded-lg p-6" style={{
                  ...
                  <div className="flex-1">
                    <div className="mb-2 flex items-start gap-16">
                      <div>
                        ...
                        <p className="text-xl font-bold text-white">{session.user.name || 'Discord User'}</p>
                      </div>
                      <div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-700">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-gray-300">Connected via Discord</span>
                  </div>
                </div>
              </div>
            ) : hasPasswordAuth ? (
        ...
        <div className="relative overflow-hidden rounded-xl shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white font-bold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-red-500/25 flex items-center justify-center"
            >
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-gray-700 to-gray-600 hover:from-gray-600 hover:to-gray-500 text-white font-bold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg flex items-center justify-center"
            >
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
