      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">
            You don't have the required Discord role to access this terminal
          </p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4">
            <div className="text-sm text-red-300">
              ...
              <ul className="mt-2 list-disc list-inside space-y-1">
                <li>Must be a member of the authorized Discord server</li>
                <li>Must have the required role assigned</li>
          ...
          <div className="flex flex-col space-y-2">
            ...
            >
              Try Again with Different Discord Account
            </button>
            
            <a
              href="mailto:support@efitrading.com"
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500">
              If you're a new user, please contact your administrator to get the required Discord role assigned.
            </p>
          </div>
        </div>
      </div>
