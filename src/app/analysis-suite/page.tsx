        ...
        >
          ...
          <div
            style={{
              ...
              boxShadow:
                '0 8px 32px rgba(0, 0, 0, 0.8), 0 2px 8px rgba(0, 0, 0, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.1), inset 0 -1px 0 rgba(0, 0, 0, 0.8)',
              position: 'relative',
              zIndex: 100,
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', zIndex: 1 }}>
              <input
                ...
                style={{
                  ...
                  boxShadow:
                    'inset 0 2px 4px rgba(0, 0, 0, 0.6), inset 0 -1px 0 rgba(255, 255, 255, 0.05), 0 1px 0 rgba(255, 255, 255, 0.1)',
                }}
              />
            </div>
