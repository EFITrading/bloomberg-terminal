...
export async function GET(request: NextRequest) {
  try {
    ...
    // CRITICAL: Use sort=desc to get MOST RECENT data first, avoiding limit cutoff issues
    ...
    }).reverse(); // CRITICAL: Reverse since we got desc data but chart needs asc order
