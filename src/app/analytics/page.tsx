  ...
  return (
    <>
      <style>{`
        ...
        /* Mobile overrides are in analytics.mobile.css (imported above) */
      ...
      >
        {/* Mobile nav dropdown — extracted to AnalyticsMobileNav.tsx */}
        <AnalyticsMobileNav activePanel={activePanel} onSelectPanel={setActivePanel} />
