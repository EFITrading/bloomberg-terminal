...
class UltraHighPerformanceOptionsFlowService {
 ...
 console.log(` Configuration: ${this.maxWorkers} workers, streaming=${this.enableStreaming}, calc-optimization=${this.enableCalculationOptimization}, benchmarking=${this.enableBenchmarking}`);
 ...
 */
 ...
 console.log(`⏱ Total time: ${processTime.toFixed(2)}ms | Trades found: ${results.length} | Rate: ${(results.length / (processTime / 1000)).toFixed(2)} trades/sec`);
