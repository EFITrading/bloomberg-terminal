...
class BackgroundDataService {
 ...
 console.warn(` Failed to load essential data for ${symbol}:`, error);
 }
 }
 } catch (error) {
 console.warn(' Essential data loading failed:', error);
 }
 }
 ...
 console.warn(' Featured patterns loading failed:', error);
 }
 }
 ...
 console.warn(' Weekly patterns loading failed:', error);
 }
 }
 ...
 console.warn(` Failed to load ${sector} patterns:`, error);
 }
 }
 } catch (error) {
 console.warn(' Sector patterns loading failed:', error);
 }
 }
 ...
 console.warn(' Market indices loading failed:', error);
 }
 }
 ...
 console.warn(` Failed to load seasonal chunk ${offset}-${offset + chunkSize}:`, error);
 }
 }
 ...
 console.warn(' Seasonal opportunities loading failed:', error);
 }
 }
