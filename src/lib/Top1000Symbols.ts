...
export const TOP_1800_SYMBOLS = [
 ...
 'LUV', 'AAL', 'ALK', 'JBLU', 'MESA', 'SKYW', 'ATSG',
 'CHRW', 'XPO', 'JBHT', 'KNX', 'LSTR', 'MATX', 'ODFL', 'SAIA', 'WERN',
 'EXPD', 'HUBG', 'MRTN', 'ARCB', 'CVLG', 'FWRD', 'HTLD', 'LQDT',
 ...
 'WSO', 'BECN', 'BMI', 'BOOM', 'BRC', 'BWA', 'CBT', 'CCS', 'CPS',
 'CR', 'CXT', 'DAN', 'DY', 'FAST', 'FLOW', 'GGG', 'GTLS', 'HII',
 'HY', 'IIIN', 'IR', 'KAI', 'KALU', 'KMT', 'LAUR', 'LMB', 'LECO', 'MDT',
 'MLI', 'MSM', 'MWA', 'NPO', 'NR', 'NVST', 'OFLX', 'OMI', 'OSIS', 'PATK',
 'PB', 'PII', 'PLUG', 'PRIM', 'PVH', 'RBC', 'RES', 'SCSC',
 'SENEA', 'SENEB', 'SHO', 'SKX', 'SMG', 'SPXC', 'SXI', 'TDW', 'TEX', 'THO',
 'TKR', 'TNC', 'TPG', 'TRN', 'TRS', 'UFI', 'UNF', 'VLGEA', 'WERN',
 'WTS', 'XRAY', 'ZWS', 'AIT', 'ALG', 'ARKR', 'ASGN', 'ACIW', 'ALRM',
 'ALTR', 'AMED', 'AMKR', 'AMWD', 'AN', 'ANET', 'ANSS', 'APPF', 'ARCC', 'ARE',
 'ARES', 'ARMK', 'ASO', 'ATEX', 'ATKR', 'ATO', 'ATRC', 'AUB', 'AUPH',
 'AVAV', 'AVD', 'AVNT', 'AVY', 'AXON', 'AZPN', 'BDC', 'BEKE', 'BILL',
 ...
 'CENT', 'CFLT', 'CFR', 'CG', 'CHD', 'CHEF', 'CHH', 'CHPT',
 'CIG', 'CIVI', 'CLF', 'CLH', 'CLNE', 'CLVT', 'CLX', 'CMA',
 'CMCO', 'CMG', 'CMPR', 'CMS', 'CNC', 'CNK', 'CNM', 'CNO', 'CNS', 'CNX',
 'COKE', 'COLD', 'COLM', 'COMM', 'COO', 'CP', 'CPA', 'CPB',
 'CPK', 'CPRX', 'CPT', 'CRBP', 'CRC', 'CRI', 'CRL', 'CROX', 'CRS', 'CRSP',
 'CSGP', 'CSL', 'CSR', 'CSTM', 'CSV', 'CSW', 'CSWI', 'CTA',
 'CTLT', 'CTM', 'CTOS', 'CTS', 'CTV', 'CUK', 'CUTR', 'CVBF', 'CVI',
 'CVLT', 'CVU', 'CW', 'CWCO', 'CWH', 'CWK', 'CWST', 'CWT', 'CX', 'CXM',
 'CYBR', 'CYTK', 'CZR', 'DAR', 'DAVA', 'DBX', 'DCI', 'DDD', 'DDOG',
